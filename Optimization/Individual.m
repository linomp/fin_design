...
classdef Individual < matlab.mixin.Copyable 
    ...
    methods
        ...
        function res = gt(obj1, obj2) 
            ...
            % obj1.fitness > obj2.fitness : minimization
            % obj1.fitness < obj2.fitness : maximization
            %if strcmp(obj1.optimizationMode, 'min') 
            %    criteria = obj1.fitness < obj2.fitness;
            %elseif strcmp(obj1.optimizationMode, 'max')  
                criteria = obj1.fitness > obj2.fitness;
            %end
